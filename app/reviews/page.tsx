...
export const metadata: Metadata = {
  ...
  description: 'Independent reviews of AI trading systems, automated gold strategies and brokers using an evidence-first methodology.',
  alternates: { canonical: '/reviews' },
  openGraph: {
    title: 'AI Trading Reviews',
    description: 'Independent trading-system reviews focused on evidence, fees, drawdown and custody.',
    url: '/reviews',
  },
};
...
export default function Page(){return <main><Breadcrumbs items={[{name:'Home',href:'/'},{name:'Reviews',href:'/reviews'}]} /><div className="eyebrow">Independent analysis</div><h1 className="page-title">AI Trading Reviews</h1><p className="lead">Our reviews focus on evidence, drawdown, leverage, fees, custody and what can actually be verified — not headline ROI alone.</p>
