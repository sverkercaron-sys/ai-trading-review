...
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://soniqe.com';
...
const websiteJsonLd={'@context':'https://schema.org','@type':'WebSite',name:'Soniqe',alternateName:'AI Trading Review',url:siteUrl};
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="en"><body><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(organizationJsonLd)}}/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(websiteJsonLd)}}/><header><Link className="brand" href="/">SONI<span>QE</span></Link><nav><Link href="/tools">Tools</Link><Link href="/guides">Guides</Link><Link href="/reviews">Reviews</Link></nav></header>{children}<footer><strong>Soniqe</strong><p>AI Trading Reviews, Tools & Research</p><p><Link href="/about">About</Link> · <Link href="/methodology">Methodology</Link> · <Link href="/editorial-policy">Editorial Policy</Link> · <Link href="/affiliate-disclosure">Affiliate Disclosure</Link> · <Link href="/risk-disclosure">Risk Disclosure</Link></p><small>Trading and leveraged products involve substantial risk. Historical results do not guarantee future performance. Nothing on this site is personalised financial advice.</small></footer></body></html>}
